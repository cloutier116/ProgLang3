	...
	public Star(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo.Star", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void init(int i, String file, int _numStars, Main _main, int _actorNum, int _theaterNum) {
			...
			try {
			...
			catch (IOException ioError) {
				{
					...
					{
						Object _arguments[] = { "Error, can't open file "+file };
		...
		public void calc(int myLoc) {
			...
			avg /= (numStars-1);
			{
				...
				{
					Object _arguments[] = { min, minStar, max, maxStar, avg, myPos, actorNum, theaterNum, starIndex };
